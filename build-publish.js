...
(async function build() {
  ...
  await concat(files, './dist/rewards-component/rewards-component.js');
  await fs.ensureDirSync('./dist/rewards-component/js');
  await fs.copy('./dist/rewards-component/rewards-component.js', './dist/rewards-component/js/rewards-component.js');
